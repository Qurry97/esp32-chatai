#ifndef LVGL_RESOURCES_H
#define LVGL_RESOURCES_H

#include <lvgl.h>

//logo img
LV_IMG_DECLARE(bootlogo1);
LV_IMG_DECLARE(bootlogo2);
LV_IMG_DECLARE(bootlogo3);
LV_IMG_DECLARE(bootlogo4);
LV_IMG_DECLARE(bootlogo5);
LV_IMG_DECLARE(bootlogo6);
LV_IMG_DECLARE(bootlogo7);
LV_IMG_DECLARE(bootlogo8);
LV_IMG_DECLARE(bootlogo9);
LV_IMG_DECLARE(bootlogo10);
LV_IMG_DECLARE(bootlogo11);
LV_IMG_DECLARE(bootlogo12);
LV_IMG_DECLARE(bootlogo13);
LV_IMG_DECLARE(bootlogo14);
LV_IMG_DECLARE(bootlogo15);
LV_IMG_DECLARE(bootlogo16);
LV_IMG_DECLARE(bootlogo17);
LV_IMG_DECLARE(bootlogo18);
...
LV_IMG_DECLARE(neutral2);
LV_IMG_DECLARE(neutral3);
LV_IMG_DECLARE(neutral4);
LV_IMG_DECLARE(neutral5);
...
LV_IMG_DECLARE(angry2);
LV_IMG_DECLARE(angry3);
LV_IMG_DECLARE(angry4);
...
LV_IMG_DECLARE(loving2);
LV_IMG_DECLARE(loving3);
