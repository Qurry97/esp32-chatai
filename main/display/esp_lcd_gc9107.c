...
//  {cmd, { data }, data_size, delay_ms}
    ...
    {0xAB, (uint8_t []){0x07}, 1, 0},
    {0xB4, (uint8_t []){0x00}, 1, 0},
    {0xA8, (uint8_t []){0x0C}, 1, 0},
    {0x3A, (uint8_t []){0x05}, 1, 0},
    // {0x36, (uint8_t []){0xa0}, 1, 0},  //0XC0  0X60  0XA0  0x00
    {0xB8, (uint8_t []){0x08}, 1, 0},
    {0xE8, (uint8_t []){0x23}, 1, 0},
    {0xE9, (uint8_t []){0x47}, 1, 0},
    {0xEA, (uint8_t []){0x44}, 1, 0},
    {0xEB, (uint8_t []){0xE0}, 1, 0},
    {0xED, (uint8_t []){0x03}, 1, 0},
    {0xC6, (uint8_t []){0x19}, 1, 0},
    {0xC7, (uint8_t []){0x10}, 1, 0},
    {0xF0, (uint8_t []){0X0B,0X2F,0X10,0X4B,0X28,0X3F,0X3E,0X60,0X00,0X12,0X12,0X0F,0X00,0X1F}, 14, 0},
    {0xF1, (uint8_t []){0x0E,0X3D,0X2A,0X40,0XFA,0X00,0X02,0X60,0X00,0X03,0X13,0X00,0X10,0X1F}, 14, 120},
